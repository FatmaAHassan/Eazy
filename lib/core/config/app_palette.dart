...
class AppPalette {
  ...
  static const foregroundLight = Color(0xFFF3F3F3);
  static const primary = Color(0xFF2A72AD);
  static const primaryLight = Color(0xFF2A72AD1F);
  static const sectionBackgroundOrange = Color(0XFFFDA958);
...
// border color
  ...
  // bottom nav bar
  static const bottomNavigationLight = backgroundLight;
  static const selectedIconLight = primary;
  // static const unselectedIconLight = lightBlack;

  static const onboardingBackgroundLight = primaryMidLight;

  // Avatar
  // static const avatarBackGround = ;
}
