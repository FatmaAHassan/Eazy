  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "تواصل معنا",
            style: TextStyle(color: AppPalette.textBlack,fontSize: 30,fontWeight: FontWeight.bold)
        ),
        centerTitle: true,
        actions: [
          IconButton(
            icon: const Icon(
                Icons.arrow_forward_ios, color: AppPalette.textBlack),
